...
jira_key: J01-102
permalink: /en/jira/issues/J01-102/
---
...
| Public work doc is reachable directly from Jira | Jira keeps one canonical remote link to `/en/jira/issues/J01-102/` | Jira remote links for `J01-102` | done |
...
- [J01-96: Anchor the source register and raw chat inputs]({{ "/en/jira/issues/J01-96/" | relative_url }})
