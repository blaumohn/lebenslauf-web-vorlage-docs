---
layout: page
title: "Jira-Übersicht: Backlog"
permalink: /de/mirror/backlog/
---
...
### [J01-5 — Qualitätsrahmen für App und Config-Lib]({{ "/de/mirror/issues/J01-5/" | relative_url }})
...
- [J01-28 — Analyse: Risikomuster und Befundliste]({{ "/de/mirror/issues/J01-28/" | relative_url }})
  ...
  - [**28-2 Priorisierung und Folge-Tickets**]({{ "/de/mirror/issues/J01-28/steps/J01-30/" | relative_url }}) — Zu erledigen
...
- [J01-34 — CLI-UX: Missing-Config und Pipeline-Phase]({{ "/de/mirror/issues/J01-34/" | relative_url }})
  - [**34-1 Pipeline-Phase-Syntax festlegen**]({{ "/de/mirror/issues/J01-34/steps/J01-35/" | relative_url }}) — Zu erledigen
  - [**34-2 Missing-Config-Befehl definieren**]({{ "/de/mirror/issues/J01-34/steps/J01-36/" | relative_url }}) — Zu erledigen
- [J01-37 — Config: Konditionelle Validierung]({{ "/de/mirror/issues/J01-37/" | relative_url }})
  - [**37-1 Schema um Bedingungen erweitern**]({{ "/de/mirror/issues/J01-37/steps/J01-38/" | relative_url }}) — Zu erledigen
  - [**37-2 Validierung + Doku ergänzen**]({{ "/de/mirror/issues/J01-37/steps/J01-39/" | relative_url }}) — Zu erledigen
- [J01-40 — Runtime: Technische Konstanten vereinheitlichen]({{ "/de/mirror/issues/J01-40/" | relative_url }})
  - [**40-1 Konstanten-Schnitt definieren**]({{ "/de/mirror/issues/J01-40/steps/J01-41/" | relative_url }}) — Zu erledigen
  - [**40-2 Pfad/Key-Duplikate entfernen**]({{ "/de/mirror/issues/J01-40/steps/J01-42/" | relative_url }}) — Zu erledigen
- [J01-43 — Preview: FTP/FTPS-Verwaltungsskripte]({{ "/de/mirror/issues/J01-43/" | relative_url }})
  - [**43-1 Marker/Signaldatei-Flow definieren**]({{ "/de/mirror/issues/J01-43/steps/J01-44/" | relative_url }}) — Zu erledigen
  - [**43-2 Doku + Tests ergänzen**]({{ "/de/mirror/issues/J01-43/steps/J01-45/" | relative_url }}) — Zu erledigen
- [J01-9 — Preview: Workflow wieder aktivieren]({{ "/de/mirror/issues/J01-9/" | relative_url }})
  - [**9-1 CI-Gates finalisieren**]({{ "/de/mirror/issues/J01-9/steps/J01-10/" | relative_url }}) — Zu erledigen
  - [**9-2 Deploy-Checks validieren**]({{ "/de/mirror/issues/J01-9/steps/J01-11/" | relative_url }}) — Zu erledigen
  - [**9-3 Branch-Flow dokumentieren**]({{ "/de/mirror/issues/J01-9/steps/J01-12/" | relative_url }}) — Zu erledigen

### [J01-6 — i18n für Seitenvorlagen und Templates]({{ "/de/mirror/issues/J01-6/" | relative_url }})
...
- [J01-49 — i18n: Template-Texte i18n-fähig machen]({{ "/de/mirror/issues/J01-49/" | relative_url }})
  - [**49-1 Template-Text-Keys definieren**]({{ "/de/mirror/issues/J01-49/steps/J01-50/" | relative_url }}) — Zu erledigen
  - [**49-2 DE/EN Mindestumfang liefern**]({{ "/de/mirror/issues/J01-49/steps/J01-51/" | relative_url }}) — Zu erledigen

### [J01-7 — Production Deployment]({{ "/de/mirror/issues/J01-7/" | relative_url }})

- [J01-62 — Production: Branch- und Environment-Regeln aktivieren]({{ "/de/mirror/issues/J01-62/" | relative_url }})
  - [**62-1 Branch-Mapping festlegen**]({{ "/de/mirror/issues/J01-62/steps/J01-63/" | relative_url }}) — Zu erledigen
  - [**62-2 Environment aktivieren**]({{ "/de/mirror/issues/J01-62/steps/J01-64/" | relative_url }}) — Zu erledigen
...
- [J01-68 — Production: Betriebsdoku und Runbook]({{ "/de/mirror/issues/J01-68/" | relative_url }})
  - [**68-1 Betriebsdoku erstellen**]({{ "/de/mirror/issues/J01-68/steps/J01-69/" | relative_url }}) — Zu erledigen
  - [**68-2 Rollback/Notfallpfad skizzieren**]({{ "/de/mirror/issues/J01-68/steps/J01-70/" | relative_url }}) — Zu erledigen

### [J01-8 — Backlog-Kandidaten]({{ "/de/mirror/issues/J01-8/" | relative_url }})

- [J01-52 — Backlog: Typensicherheit statt Guards]({{ "/de/mirror/issues/J01-52/" | relative_url }})
  - [**52-1 Scope skizzieren**]({{ "/de/mirror/issues/J01-52/steps/J01-53/" | relative_url }}) — Zu erledigen
- [J01-54 — Backlog: Zentrales Fehlerkonzept]({{ "/de/mirror/issues/J01-54/" | relative_url }})
  - [**54-1 Scope skizzieren**]({{ "/de/mirror/issues/J01-54/steps/J01-55/" | relative_url }}) — Zu erledigen
- [J01-56 — Backlog: Bibliotheks-APIs konsequent ausschoepfen]({{ "/de/mirror/issues/J01-56/" | relative_url }})
  - [**56-1 Scope skizzieren**]({{ "/de/mirror/issues/J01-56/steps/J01-57/" | relative_url }}) — Zu erledigen
- [J01-58 — Backlog: Pipeline-Phase Terminologie repo-weit]({{ "/de/mirror/issues/J01-58/" | relative_url }})
  - [**58-1 Scope skizzieren**]({{ "/de/mirror/issues/J01-58/steps/J01-59/" | relative_url }}) — Zu erledigen
- [J01-60 — Backlog: SMTP-Empfangsnachweis mit Konto-Beteiligung]({{ "/de/mirror/issues/J01-60/" | relative_url }})
  - [**60-1 Scope skizzieren**]({{ "/de/mirror/issues/J01-60/steps/J01-61/" | relative_url }}) — Zu erledigen
...
- [J01-85 — Atlassian-System vorbereiten (SSOT: Jira) – Tooling-Backlog-Container]({{ "/de/mirror/issues/J01-85/" | relative_url }})
  ...
  - [**85-3 Backlog: Confluence-Spiegel periodisch aktualisieren (Batch; optional Warteschlange)**]({{ "/de/mirror/issues/J01-85/steps/J01-87/" | relative_url }}) — Zu erledigen
  - [**85-4 Backlog: Feature-Matrix für Tooling-Betriebe vervollständigen**]({{ "/de/mirror/issues/J01-85/steps/J01-97/" | relative_url }}) — Zu erledigen
