...
Die am 2026-06-01 ergänzten Go-live-Restschritte `J01-152`, `J01-153` und
`J01-154` sind inzwischen umgesetzt und in Jira abgeschlossen.
...
| Production-Inhalt | CI kann die Production-Inhaltsquelle laden | Hauptrepo-Commit `318d77e`, J01-152 | erledigt |
| Publish-Pfad | CV-HTML wird atomar veröffentlicht und per HTTP geprüft | Hauptrepo-Commits `33768cf`, `5ad711f`, `97a3cdb`, `7341f10` | erledigt |
| Reales Profil | Production nutzt ein gültiges öffentliches Profil | Hauptrepo-Commit `d5202b6` | erledigt |
| Go-live | Produktion ist live | Bestätigung vom 2026-06-04, Sprint-5-Review | erledigt |
