...
permalink: /de/jira/issues/J01-72/steps/J01-91/archive-topics/
---
...
| Config-Policy (Sources/Validation) | soll übernommen werden | teilweise umgesetzt | Manifest- und Source-Grundzüge sind öffentlich erklärt, aber noch nicht als vollständiger Übernahmestatus aus den Altquellen ausgewiesen | [CLI / Build]({{ "/de/areas/cli-build/" | relative_url }}), [J01-31]({{ "/de/jira/issues/J01-31/" | relative_url }}) | Weiterer Vollabgleich jetzt in [J01-103]({{ "/de/jira/issues/J01-103/" | relative_url }}) |
